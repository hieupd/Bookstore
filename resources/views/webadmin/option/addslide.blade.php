...
@section('Content')
                    ...
                    <form action="/admin/dashboard/slidemanager/addslide" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        @if(count($errors) > 0)
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                     ...
                                     <input class="form-control" style="width: 650px" name="slide_name" placeholder="Nhập tên slide" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="demo" class="ckeditor" name="slide_dsc"></textarea>
                        </div>
