                ...
                <div class="col-sm-24">
                    <div class="breadcrumbs">
                        <ul>
                            ...
                            <li class="contact"> <strong>  {{$Category_name->category_name}}</strong>
                            </li>
                        </ul>
                    </div>
                </div>
                                        ...
                                        <dd>
                                            <ol class="filter tree-filter">
                                                @foreach($ListType as $item)
                                                    @if($item->category_id == $Category_name->category_id)
                                                    <li>
    ...
    <script>
        $('document').ready(function () {
            $('#toolbar-show').change(function () {
                var categoryid = {{$Category_name->category_id}}+"";
                // var quantity = $(this).val();
                var typesort = $('#sortby').val();
                 $.get("/Product/Category/"+categoryid+"/1?order="+typesort,function (data) {
                     $('#em-grid-mode').html(data);
                 });
            });
        });
        $('document').ready(function () {
            $('#sortby').change(function () {
                ...
                window.location="/Product/Category/"+categoryid+"?order="+type+"&from="+from+"&to="+to+"&sort="+sort;
