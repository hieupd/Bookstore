...
<div class="register">
    <div class="container">
        ...
        <div class="login-form-grids">
            <h5 class="animated wow slideInUp" data-wow-delay=".5s">Thông tin khách hàng</h5>
            <form class="animated wow slideInUp" data-wow-delay=".5s">
                <input type="text" placeholder="First Name..." required=" ">
                <input type="text" placeholder="Last Name..." required=" ">
                <input type="text" placeholder="Adđress..." required=" ">
            ...
            <form class="animated wow slideInUp" data-wow-delay=".5s">
                ...
                <div class="register-check-box">
                    <div class="check">
                        <label class="checkbox"><input type="checkbox" name="checkbox"><i> </i>Tôi đồng ý với điều khoản
                            sử dụng dịch vụ của hệ thống</label>
                    </div>
                </div>
        ...
        <div class="register-home animated wow slideInUp" data-wow-delay=".5s">
            <a href="trangchu.blade.php">Trang chủ</a>
        </div>
    </div>
</div>
<!-- //register -->
