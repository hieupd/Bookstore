...
<div class="login">
    <div class="container">
        ...
        <p class="animated wow slideInUp" data-wow-delay=".5s"><a href="register.blade.php">Đăng ký tại đây</a> (hoặc) quay lại
            <a href="trangchu.blade.php">Trang chủ<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></a></p>
    </div>
</div>
<!-- //login -->
<!-- footer -->
