	...
	<div class="container">
		<div class="header-grid">
			<div class="header-grid-left animated wow slideInLeft" data-wow-delay=".5s">
				<ul>
					...
					<li><i class="glyphicon glyphicon-log-in" aria-hidden="true"></i><a href="C:\Users\Admin\Desktop\Bookstore\webAdmin\index.html">Admin</a>
					</li>
				</ul>
			</div>
		...
		<div class="logo-nav">
			<div class="logo-nav-left animated wow zoomIn" data-wow-delay=".5s">
				<h1><a href="trangchu.blade.php">Book Store <span>Shop anywhere</span></a></h1>
			</div>
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav">
							<li class="active"><a href="trangchu.blade.php" class="act">Trang Chủ</a></li>
							<!-- Mega Menu -->
							<li class="dropdown">
							...
							<li><a href="mail.blade.php">Liên hệ với chúng tôi</a></li>
						</ul>
					</div>
				</nav>
			</div>
			...
			<div class="mail-grids">
				...
				<div class="col-md-4 mail-grid-right animated wow slideInRight" data-wow-delay=".5s">
					<div class="mail-grid-right1">
						...
						<h4>Nguyễn Thị Hồng Ngọc <span>Founder - Manager</span></h4>
						<ul class="phone-mail">
