...
<!-- Mirrored from htmlcooker.com/tvlgiao/everything/assets/everything/fashion/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Oct 2015 02:43:35 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="row">
                                        ...
                                        <form id="wishlist-view-form" method="post">
                                            <fieldset>
                                                ...
                                                <table class="data-table" id="wishlist-table">
                                                    ...
                                                    <tr id="item_6">
                                                        <td>
                                                            <a class="product-image" href="product-detail.html" title=" Mommy's little sunshine graphic tee "> <img src="images/product/113x113/baby_13_1.jpg" width="113" height="113" alt=" Mommy's little sunshine graphic tee " /> </a>
                                                        </td>
                                                        <td>
                                                            <h3 class="product-name"><a href="product-detail.html" title=" Mommy's little sunshine graphic tee "> Mommy's little sunshine graphic tee </a></h3>
                                                        ...
                                                        <td>
                                                            <div class="cart-cell">
                                                                <div class="price-box" itemscope itemtype="http://schema.org/Product"> <span class="regular-price" id="product-price-258"> <span class="price"  content="4.85">$4.85</span> </span>
                                                                </div>
                            ...
                            <div class="col-sm-6 col-sm-pull-18 em-col-left em-sidebar">
                                ...
                                <div class="block block-wishlist em-line-01">
                                    <div class="block-title em-block-title"> <strong><span>My Wishlist <small>(1)</small></span></strong>
                                    </div>
                                    <div class="block-content">
                                        <p class="block-subtitle">Last Added Items</p>
                                        <ol class="mini-products-list" id="wishlist-sidebar">
                                            <li class="item">
                                                <a href="product-detail.html" title=" Mommy's little sunshine graphic tee " class="product-image"><img src="images/product/100x100/thumbnail.jpg" width="100" height="100" alt=" Mommy's little sunshine graphic tee " />
                                                </a>
                                                <div class="product-details"> <a href="#" title="Remove This Item" class="btn-remove">Remove This Item</a>
                                                    <p class="product-name"><a href="product-detail.html"> Mommy's little sunshine graphic tee </a>
                                                    </p>
                                                    <div class="price-box" itemscope itemtype="http://schema.org/Product"> <span class="regular-price" id="product-price-258-wishlist"> <span class="price"  content="4.85">$4.85</span> </span>
                                                    </div><a href="#" class="link-cart" title="Add to Cart"><span><span>Add to Cart</span></span></a>
                                                </div>
                                            </li>
                                        </ol>
                                        <div class="actions"> <a href="#" class="button-link"><span><span>Go to Wishlist</span></span></a>
                                        </div>
                                    </div>
                                </div><!-- /.block-wishlist -->
                            </div><!-- /.em-sidebar -->
