		...
		<div class="container">
			...
			<div class="logo-nav">
				<div class="logo-nav-left animated wow zoomIn" data-wow-delay=".5s">
					<h1><a href="trangchu.blade.php">Best Store <span>Shop anywhere</span></a></h1>
				</div>
				<div class="logo-nav-left1">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav">
							<li><a href="trangchu.blade.php">Home</a></li>
							<!-- Mega Menu -->
							 <li class="dropdown">
									...
									<div class="row">
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												...
												<li><a href="productsbycategory.blade.php">Wallets</a></li>
												<li><a href="productsbycategory.blade.php">Shoes</a></li>
										...
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<h6>Kid's Wear</h6>
												<li><a href="productsbycategory.blade.php">Kids Home Fashion</a></li>
												<li><a href="productsbycategory.blade.php">Boy's Clothing</a></li>
												<li><a href="productsbycategory.blade.php">Girl's Clothing</a></li>
												<li><a href="productsbycategory.blade.php">Shoes</a></li>
												<li><a href="productsbycategory.blade.php">Brand Stores</a></li>
											</ul>
										</div>
										<div class="clearfix"></div>
									</div>
							...
							<li><a href="short-codes.blade.php">Short Codes</a></li>
							<li><a href="mail.blade.php">Mail Us</a></li>
						</ul>
					</div>
					</nav>
				</div>
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				<li><a href="trangchu.blade.php"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Home</a></li>
		...
		<div class="container">
			<div class="col-md-4 products-left">
				...
				<div class="categories animated wow slideInUp" data-wow-delay=".5s">
					<h3>Categories</h3>
					<ul class="cate">
						<li><a href="furniture.blade.php">Best Selling</a> <span>(15)</span></li>
						<li><a href="furniture.blade.php">Home Collections</a> <span>(16)</span></li>
							<ul>
								<li><a href="furniture.blade.php">Cookware</a> <span>(2)</span></li>
								<li><a href="furniture.blade.php">Sofas</a> <span>(5)</span></li>
								<li><a href="furniture.blade.php">Dining Tables</a> <span>(1)</span></li>
								<li><a href="furniture.blade.php">New Arrivals</a> <span>(0)</span></li>
								<li><a href="furniture.blade.php">Home Decore</a> <span>(1)</span></li>
							</ul>
						<li><a href="furniture.blade.php">Sales</a> <span>(15)</span></li>
						<li><a href="furniture.blade.php">Decorations</a> <span>(15)</span></li>
							<ul>
								<li><a href="furniture.blade.php">Wall Clock</a> <span>(2)</span></li>
								<li><a href="furniture.blade.php">New Arrivals</a> <span>(0)</span></li>
								<li><a href="furniture.blade.php">Lighting</a> <span>(1)</span></li>
								<li><a href="furniture.blade.php">Top Brands</a> <span>(0)</span></li>
							</ul>
					</ul>
				</div>
					...
					<div class="new-products-grids">
						<div class="new-products-grid">
							...
							<div class="new-products-grid-right">
								<h4><a href="single.blade.php">occaecat cupidatat</a></h4>
								<div class="rating">
						...
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single.blade.php"><img src="images/11.jpg" alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
			...
			<div class="col-md-8 products-right">
				...
				<div class="products-right-grids-bottom">
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
							<div class="new-collections-grid1-image">
								<a href="single.blade.php" class="product-image"><img src="images/30.jpg" alt=" " class="img-responsive"></a>
							...
							<h4><a href="single.blade.php">Centre Table</a></h4>
						...
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
							<div class="new-collections-grid1-image">
								<a href="single.blade.php" class="product-image"><img src="images/32.jpg" alt=" " class="img-responsive"></a>
								<div class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single.blade.php">Quick View</a>
								</div>
								<div class="new-collections-grid1-right products-right-grids-pos-right">
							...
							<h4><a href="single.blade.php">Media Cabinet</a></h4>
							<p>Vel illum qui dolorem.</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p><i>$325</i> <span class="item_price">$250</span><a class="item_add" href="#">add to cart </a></p>
							</div>
						...
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
							<div class="new-collections-grid1-image">
								<a href="single.blade.php" class="product-image"><img src="images/31.jpg" alt=" " class="img-responsive"></a>
								<div class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single.blade.php">Quick View</a>
								</div>
								<div class="new-collections-grid1-right products-right-grids-pos-right">
							...
							<h4><a href="single.blade.php">Entertainment Unit</a></h4>
							<p>Vel illum qui dolorem.</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
					...
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
							<div class="new-collections-grid1-image">
								<a href="single.blade.php" class="product-image"><img src="images/33.jpg" alt=" " class="img-responsive"></a>
								<div class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single.blade.php">Quick View</a>
								</div>
								<div class="new-collections-grid1-right products-right-grids-pos-right">
							...
							<h4><a href="single.blade.php">2 Seater Sofa</a></h4>
							<p>Vel illum qui dolorem.</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
						...
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
							<div class="new-collections-grid1-image">
								<a href="single.blade.php" class="product-image"><img src="images/6.jpg" alt=" " class="img-responsive"></a>
								<div class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single.blade.php">Quick View</a>
								</div>
								<div class="new-collections-grid1-right products-right-grids-pos-right">
							...
							<h4><a href="single.blade.php">Street Lamp</a></h4>
							<p>Vel illum qui dolorem.</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
						...
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
							<div class="new-collections-grid1-image">
								<a href="single.blade.php" class="product-image"><img src="images/9.jpg" alt=" " class="img-responsive"></a>
								<div class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single.blade.php">Quick View</a>
								</div>
								<div class="new-collections-grid1-right products-right-grids-pos-right">
					...
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
							<div class="new-collections-grid1-image">
								<a href="single.blade.php" class="product-image"><img src="images/10.jpg" alt=" " class="img-responsive"></a>
								<div class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single.blade.php">Quick View</a>
								</div>
								<div class="new-collections-grid1-right products-right-grids-pos-right">
							...
							<h4><a href="single.blade.php">Anklet</a></h4>
							<p>Vel illum qui dolorem.</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
						...
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
							<div class="new-collections-grid1-image">
								<a href="single.blade.php" class="product-image"><img src="images/11.jpg" alt=" " class="img-responsive"></a>
								<div class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single.blade.php">Quick View</a>
								</div>
								<div class="new-collections-grid1-right products-right-grids-pos-right">
							...
							<h4><a href="single.blade.php">Stone Bangles</a></h4>
							<p>Vel illum qui dolorem.</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
						...
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
							<div class="new-collections-grid1-image">
								<a href="single.blade.php" class="product-image"><img src="images/34.jpg" alt=" " class="img-responsive"></a>
								<div class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single.blade.php">Quick View</a>
								</div>
								<div class="new-collections-grid1-right products-right-grids-pos-right">
							...
							<h4><a href="single.blade.php">Analog Wall Clock</a></h4>
							<p>Vel illum qui dolorem.</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p><i>$585</i> <span class="item_price">$489</span><a class="item_add" href="#">add to cart </a></p>
							</div>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="footer-logo animated wow slideInUp" data-wow-delay=".5s">
				<h2><a href="trangchu.blade.php">Best Store <span>shop anywhere</span></a></h2>
			</div>
