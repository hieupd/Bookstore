...
(function(a){
    a.fn.amazon_scroller=function(p){
        ...
        var l=p&&p.scroller_border_color?p.scroller_border_color:"gainsboro";
        var m=p&&p.scroller_images_width?p.scroller_images_width:"300";
        var n=p&&p.scroller_images_height?p.scroller_images_height:"500";
        ...
        function s_s_ul(a,b,c,d,e){
            b=parseInt(b);
            c=parseInt(c);
            var f="border: "+d+" solid "+" "+c+"px; padding:"+b+"px;";
        ...
        function s_s_nav(a,d){
            ...
            // a.children("li").css('background-image','url("'+d+'/assets/background/img/arrow.gif")');
            a.children("li").css('background-image','url("/assets/background/img/arrow_new.png")');
